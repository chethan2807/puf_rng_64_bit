...
## Pmod Header JB
#set_property -dict { PACKAGE_PIN E15   IOSTANDARD LVCMOS33 } [get_ports { rng_clk1 }]; #IO_L11P_T1_SRCC_15 Sch=jb_p[1]
...
#set_property -dict { PACKAGE_PIN C15   IOSTANDARD LVCMOS33 } [get_ports { rng_clk2 }]; #IO_L12N_T1_MRCC_15 Sch=jb_n[2]
...
set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets challenge[*]]
set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets puf_32bit/*_ro*/*]